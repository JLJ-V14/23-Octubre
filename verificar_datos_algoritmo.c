...
static int comprobar_resolucion_tiempo_simulacion(datos_csv_algoritmo_t* datos_algoritmo) {
	...
	wchar_t* resolucion_minutos = informacion_algoritmo->datos[fila_datos_algoritmo][columna_resolucion_minutos];
	int resolucion_minutos_int = wcstol(resolucion_minutos, NULL, 10); //Se convierte a tipo int
