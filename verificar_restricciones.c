...
static int comprobar_dato_restricciones(wchar_t* dato) {
...
static int comprobar_encabezados_restricciones(datos_csv_t* datos_restricciones) {
	...
	const wchar_t* valores_aceptables[] = { L"Variable Sistema",L"Maxima Potencia Electrolinera Red",L"Maxima Potencia Terminal 1 kWh",
