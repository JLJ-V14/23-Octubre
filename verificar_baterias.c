...
static int comprobar_datos_bateria(const datos_csv_baterias_t* datos_bateria, const int numero_bateria) {
	...
	*/
	...
	wchar_t*    numero_terminal_char = informacion_baterias->datos[numero_bateria][columna_csv_baterias_num_terminal];
	wchar_t*    capacidad_bateria_char = informacion_baterias->datos[numero_bateria][columna_csv_baterias_capacidad];
	wchar_t*    maxima_potencia_char = informacion_baterias->datos[numero_bateria][columna_csv_baterias_max_potencia];
	wchar_t*    bateria_inicial_char = informacion_baterias->datos[numero_bateria][columna_csv_baterias_inicial];
	wchar_t*    bateria_deseada_char = informacion_baterias->datos[numero_bateria][columna_csv_baterias_final];
